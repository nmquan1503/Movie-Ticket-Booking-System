...
public interface MovieDirectorRepository extends JpaRepository<MovieDirector, Long>, CustomMovieDirectorRepository {

    boolean existsByMovieAndDirector(Movie movie, Person director);
